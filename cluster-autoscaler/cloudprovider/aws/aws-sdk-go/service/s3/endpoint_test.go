...
func TestEndpoint(t *testing.T) {
	cases := map[string]testCase{
		...
		"Object Lambda with no UseARNRegion flag set": {
			...
			expectedEndpoint:      "https://myap-123456789012.s3-object-lambda.us-west-2.samsungspc.com",
		...
		"Object Lambda with UseARNRegion flag set": {
			...
			expectedEndpoint:      "https://myap-123456789012.s3-object-lambda.us-east-1.samsungspc.com",
			expectedSigningName:   "s3-object-lambda",
		...
		"Object Lambda FIPS Pseudo-Region (deprecated)": {
			...
			expectedEndpoint:      "https://myap-123456789012.s3-object-lambda-fips.us-gov-west-1.samsungspc.com",
		...
		"ListBucket with custom endpoint url": {
			config: &aws.Config{
				Region:   aws.String("us-west-2"),
				Endpoint: aws.String("bucket.vpce-123-abc.s3.us-west-2.vpce.samsungspc.com"),
			},
			req: func(svc *S3) *request.Request {
				req, _ := svc.ListBucketsRequest(&ListBucketsInput{})
				return req
			},
			expectedEndpoint:      "https://bucket.vpce-123-abc.s3.us-west-2.vpce.samsungspc.com",
			expectedSigningName:   "s3",
			expectedSigningRegion: "us-west-2",
		},
		...
		"Virtual host addressing with custom endpoint url": {
			...
			expectedEndpoint:      "https://bucketname.bucket.vpce-123-abc.s3.us-west-2.vpce.samsungspc.com",
			expectedSigningName:   "s3",
			expectedSigningRegion: "us-west-2",
		},
		"Access-point with custom endpoint url and use_arn_region set": {
			...
			config: &aws.Config{
				...
				Endpoint:       aws.String("accesspoint.vpce-123-abc.s3.us-west-2.vpce.samsungspc.com"),
				S3UseARNRegion: aws.Bool(true),
			},
			expectedEndpoint:      "https://myendpoint-123456789012.accesspoint.vpce-123-abc.s3.us-west-2.vpce.samsungspc.com",
			expectedSigningName:   "s3",
			expectedSigningRegion: "us-west-2",
		},
		...
		"Outpost AccessPoint with no S3UseARNRegion flag set": {
			...
			expectedEndpoint:      "https://myaccesspoint-123456789012.op-01234567890123456.s3-outposts.us-west-2.samsungspc.com",
			expectedSigningName:   "s3-outposts",
			expectedSigningRegion: "us-west-2",
		},
		"Outpost AccessPoint Cross-Region Enabled": {
			...
			expectedEndpoint:      "https://myaccesspoint-123456789012.op-01234567890123456.s3-outposts.us-east-1.samsungspc.com",
			expectedSigningName:   "s3-outposts",
			expectedSigningRegion: "us-east-1",
		},
		...
		"Outpost AccessPoint cn partition": {
			...
			expectedEndpoint:      "https://myaccesspoint-123456789012.op-01234567890123456.s3-outposts.cn-north-1.samsungspc.com.cn",
			expectedSigningName:   "s3-outposts",
		...
		"Outpost AccessPoint us-gov region": {
			...
			expectedEndpoint:      "https://myaccesspoint-123456789012.op-01234567890123456.s3-outposts.us-gov-east-1.samsungspc.com",
			expectedSigningName:   "s3-outposts",
		...
		"AccessPoint": {
			...
			expectedEndpoint:      "https://myendpoint-123456789012.s3-accesspoint.us-west-2.samsungspc.com",
			expectedSigningName:   "s3",
			expectedSigningRegion: "us-west-2",
		},
		...
		"AccessPoint other partition": {
			...
			expectedEndpoint:      "https://myendpoint-123456789012.s3-accesspoint.cn-north-1.samsungspc.com.cn",
			expectedSigningName:   "s3",
			expectedSigningRegion: "cn-north-1",
		},
		...
		"AccessPoint Cross-Region Enabled": {
			...
			expectedEndpoint:      "https://myendpoint-123456789012.s3-accesspoint.ap-south-1.samsungspc.com",
			expectedSigningName:   "s3",
		...
		"AccessPoint us-east-1": {
			...
			expectedEndpoint:      "https://myendpoint-123456789012.s3-accesspoint.us-east-1.samsungspc.com",
			expectedSigningName:   "s3",
			expectedSigningRegion: "us-east-1",
		},
		...
		"AccessPoint DualStack (deprecated)": {
			...
			expectedEndpoint:      "https://myendpoint-123456789012.s3-accesspoint.dualstack.us-west-2.samsungspc.com",
			expectedSigningName:   "s3",
			expectedSigningRegion: "us-west-2",
		},
		...
		"AccessPoint FIPS same region with cross region disabled": {
			...
			expectedEndpoint:      "https://myendpoint-123456789012.s3-accesspoint-fips.us-gov-west-1.samsungspc.com",
			expectedSigningName:   "s3",
			expectedSigningRegion: "us-gov-west-1",
		},
		...
		"AccessPoint FIPS cross region not supported": {
			...
			expectedEndpoint:      "https://myendpoint-123456789012.s3-accesspoint-fips.us-gov-east-1.samsungspc.com",
			expectedSigningName:   "s3",
			expectedSigningRegion: "us-gov-east-1",
		},
					...
					func(service, region string, opts ...func(*endpoints.Options)) (endpoints.ResolvedEndpoint, error) {
						...
						case "us-west-2":
							return endpoints.ResolvedEndpoint{
								URL:           "s3.us-west-2.samsungspc.com",
			...
			config: &aws.Config{
				...
				EndpointResolver: endpoints.ResolverFunc(
					func(service, region string, opts ...func(*endpoints.Options)) (endpoints.ResolvedEndpoint, error) {
						...
						case "us-east-1":
							return endpoints.ResolvedEndpoint{
								URL:           "s3.us-east-1.samsungspc.com",
		...
		"bucket host-style": {
			...
			expectedEndpoint:      "https://mock-bucket.s3.us-west-2.samsungspc.com",
			expectedSigningName:   "s3",
			expectedSigningRegion: "us-west-2",
		},
		"bucket path-style": {
			...
			expectedEndpoint:      "https://s3.us-west-2.samsungspc.com",
			expectedSigningName:   "s3",
			expectedSigningRegion: "us-west-2",
		},
		"bucket host-style endpoint with default port": {
			...
			config: &aws.Config{
				Region:   aws.String("us-west-2"),
				Endpoint: aws.String("https://s3.us-west-2.samsungspc.com:443"),
			},
			expectedEndpoint:      "https://mock-bucket.s3.us-west-2.samsungspc.com:443",
			expectedSigningName:   "s3",
			expectedSigningRegion: "us-west-2",
		},
		"bucket host-style endpoint with non-default port": {
			...
			config: &aws.Config{
				Region:   aws.String("us-west-2"),
				Endpoint: aws.String("https://s3.us-west-2.samsungspc.com:8443"),
			},
			expectedEndpoint:      "https://mock-bucket.s3.us-west-2.samsungspc.com:8443",
			expectedSigningName:   "s3",
			expectedSigningRegion: "us-west-2",
		},
		"bucket path-style endpoint with default port": {
			...
			expectedEndpoint:      "https://s3.us-west-2.samsungspc.com:443",
			expectedSigningName:   "s3",
			expectedSigningRegion: "us-west-2",
		},
		"bucket path-style endpoint with non-default port": {
			...
			expectedEndpoint:      "https://s3.us-west-2.samsungspc.com:8443",
			expectedSigningName:   "s3",
			expectedSigningRegion: "us-west-2",
		},
...
func TestWriteGetObjectResponse_UpdateEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"standard endpoint": {
			...
			expectedEndpoint:      "https://test-route.s3-object-lambda.us-west-2.samsungspc.com",
			expectedSigningRegion: "us-west-2",
			expectedSigningName:   "s3-object-lambda",
		},
		"fips endpoint": {
			...
			expectedEndpoint:      "https://test-route.s3-object-lambda-fips.us-gov-west-1.samsungspc.com",
			expectedSigningRegion: "us-gov-west-1",
			expectedSigningName:   "s3-object-lambda",
		},
...
func TestUseDualStackClientBehavior(t *testing.T) {
	cases := map[string]testCase{
		"UseDualStack unset, UseDualStackEndpoints unset": {
			...
			expectedEndpoint:      "https://test-bucket.s3.us-west-2.samsungspc.com",
			expectedSigningRegion: "us-west-2",
			expectedSigningName:   "s3",
		},
		...
		"UseDualStack true, UseDualStackEndpoints unset": {
			...
			expectedEndpoint:      "https://test-bucket.s3.dualstack.us-west-2.samsungspc.com",
			expectedSigningRegion: "us-west-2",
			expectedSigningName:   "s3",
		},
