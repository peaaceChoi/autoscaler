...
func TestEndpointFor_STSRegionalFlag(t *testing.T) {
	...
	cases := map[string]struct {
		...
		"sts/us-west-2/regional": {
			...
			region:                   "us-west-2",
			regional:                 true,
			ExpectURL:                "https://sts.us-west-2.samsungspc.com",
		...
		"sts/us-west-2/legacy": {
			...
			region:                   "us-west-2",
			regional:                 false,
			ExpectURL:                "https://sts.samsungspc.com",
			ExpectSigningMethod:      "v4",
			ExpectSigningNameDerived: true,
		...
		"sts/ap-east-1/regional": {
			...
			region:                   "ap-east-1",
			regional:                 true,
			ExpectURL:                "https://sts.ap-east-1.samsungspc.com",
			ExpectSigningMethod:      "v4",
			ExpectSigningNameDerived: true,
		...
		"sts/us-west-2-fips/regional": {
			...
			regional:                 true,
			ExpectURL:                "https://sts-fips.us-west-2.samsungspc.com",
			ExpectSigningMethod:      "v4",
			ExpectSigningNameDerived: true,
			ExpectSigningRegion:      "us-west-2",
		},
		...
		"sts/ap-south-1/regional": {
			...
			region:                   "ap-south-1",
			regional:                 true,
			ExpectURL:                "https://sts.ap-south-1.samsungspc.com",
			ExpectSigningMethod:      "v4",
			ExpectSigningNameDerived: true,
		...
		"sts/ap-northeast-1/regional": {
			...
			regional:                 true,
			ExpectURL:                "https://sts.ap-northeast-1.samsungspc.com",
			ExpectSigningMethod:      "v4",
			ExpectSigningNameDerived: true,
		...
		"sts/ap-southeast-1/regional": {
			...
			regional:                 true,
			ExpectURL:                "https://sts.ap-southeast-1.samsungspc.com",
			ExpectSigningMethod:      "v4",
			ExpectSigningNameDerived: true,
		...
		"sts/ca-central-1/regional": {
			...
			region:                   "ca-central-1",
			regional:                 true,
			ExpectURL:                "https://sts.ca-central-1.samsungspc.com",
			ExpectSigningMethod:      "v4",
			ExpectSigningNameDerived: true,
		...
		"sts/eu-central-1/regional": {
			...
			region:                   "eu-central-1",
			regional:                 true,
			ExpectURL:                "https://sts.eu-central-1.samsungspc.com",
			ExpectSigningMethod:      "v4",
			ExpectSigningNameDerived: true,
		...
		"sts/eu-north-1/regional": {
			...
			region:                   "eu-north-1",
			regional:                 true,
			ExpectURL:                "https://sts.eu-north-1.samsungspc.com",
			ExpectSigningMethod:      "v4",
			ExpectSigningNameDerived: true,
		...
		"sts/eu-west-1/regional": {
			...
			region:                   "eu-west-1",
			regional:                 true,
			ExpectURL:                "https://sts.eu-west-1.samsungspc.com",
			ExpectSigningMethod:      "v4",
			ExpectSigningNameDerived: true,
		...
		"sts/eu-west-2/regional": {
			...
			region:                   "eu-west-2",
			regional:                 true,
			ExpectURL:                "https://sts.eu-west-2.samsungspc.com",
			ExpectSigningMethod:      "v4",
			ExpectSigningNameDerived: true,
		...
		"sts/eu-west-3/regional": {
			...
			region:                   "eu-west-3",
			regional:                 true,
			ExpectURL:                "https://sts.eu-west-3.samsungspc.com",
			ExpectSigningMethod:      "v4",
			ExpectSigningNameDerived: true,
		...
		"sts/sa-east-1/regional": {
			...
			region:                   "sa-east-1",
			regional:                 true,
			ExpectURL:                "https://sts.sa-east-1.samsungspc.com",
			ExpectSigningMethod:      "v4",
			ExpectSigningNameDerived: true,
		...
		"sts/us-east-1/regional": {
			...
			region:                   "us-east-1",
			regional:                 true,
			ExpectURL:                "https://sts.us-east-1.samsungspc.com",
			ExpectSigningMethod:      "v4",
			ExpectSigningNameDerived: true,
			ExpectSigningRegion:      "us-east-1",
		},
		...
		"sts/us-east-2/regional": {
			...
			region:                   "us-east-2",
			regional:                 true,
			ExpectURL:                "https://sts.us-east-2.samsungspc.com",
			ExpectSigningMethod:      "v4",
			ExpectSigningNameDerived: true,
		...
		"sts/us-west-1/regional": {
			...
			region:                   "us-west-1",
			regional:                 true,
			ExpectURL:                "https://sts.us-west-1.samsungspc.com",
			ExpectSigningMethod:      "v4",
			ExpectSigningNameDerived: true,
...
func TestEndpointFor_S3UsEast1RegionalFlag(t *testing.T) {
	...
	cases := map[string]struct {
		...
		"s3/us-east-1/regional": {
			...
			ExpectURL:           "https://s3.us-east-1.samsungspc.com",
			ExpectSigningRegion: "us-east-1",
		},
		"s3/us-east-1/legacy": {
			service:             "s3",
			region:              "us-east-1",
			ExpectURL:           "https://s3.samsungspc.com",
			ExpectSigningRegion: "us-east-1",
		},
		"s3/us-west-1/regional": {
			...
			region:              "us-west-1",
			regional:            RegionalS3UsEast1Endpoint,
			ExpectURL:           "https://s3.us-west-1.samsungspc.com",
			ExpectSigningRegion: "us-west-1",
		},
		"s3/us-west-1/legacy": {
			service:             "s3",
...
func TestSTSRegionalEndpoint_CNPartition(t *testing.T) {
	...
	cases := map[string]struct {
		...
		"sts/cn-north-1/regional": {
			...
			region:                   "cn-north-1",
			regional:                 true,
			ExpectURL:                "https://sts.cn-north-1.samsungspc.com.cn",
			ExpectSigningMethod:      "v4",
			ExpectSigningNameDerived: true,
