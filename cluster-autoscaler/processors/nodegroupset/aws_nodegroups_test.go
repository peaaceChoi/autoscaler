...
func TestIsAwsNodeInfoSimilar(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{
			description:    "eks.samsungspc.com/nodegroup empty value",
			label:          "eks.samsungspc.com/nodegroup",
			value1:         "",
			value2:         "",
			removeOneLabel: false,
		},
		{
			description:    "eks.samsungspc.com/nodegroup different values",
			label:          "eks.samsungspc.com/nodegroup",
			value1:         "foo",
			value2:         "bar",
			removeOneLabel: false,
		...
		{
			description:    "eks.samsungspc.com/nodegroup one node labeled",
			label:          "eks.samsungspc.com/nodegroup",
			value1:         "foo",
			value2:         "bar",
			removeOneLabel: true,
		...
		{
			description:    "k8s.samsungspc.com/eniConfig empty value",
			label:          "k8s.samsungspc.com/eniConfig",
			value1:         "",
			value2:         "",
			removeOneLabel: false,
		},
		{
			description:    "k8s.samsungspc.com/eniConfig different values",
			label:          "k8s.samsungspc.com/eniConfig",
			value1:         "foo",
			value2:         "bar",
			removeOneLabel: false,
		...
		{
			description:    "k8s.samsungspc.com/eniConfig one node labeled",
			label:          "k8s.samsungspc.com/eniConfig",
			value1:         "foo",
			value2:         "bar",
			removeOneLabel: true,
